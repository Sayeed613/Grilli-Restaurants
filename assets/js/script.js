...
// Add addEventListener on multiple elements
...
const navTogglers = document.querySelectorAll("[data-nav-toggler]"); // Fix the selector
...
// hero
// Define addEventOnElements function
const addEventOnElements = function (elements, event, callback) {
  ...
  // Now you can use addEventOnElements
